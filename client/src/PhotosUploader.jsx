...
function PhotosUploader({ addedPhotos, onChange }) {
  ...
  //function for removing the photo from the array of photos
        ...
        {addedPhotos.length > 0 &&
          addedPhotos.map((link) => (
            <div className="h-32 flex relative" key={link}>
              ...
              <button
                onClick={(ev) => mainPhoto(ev, link)}
                className="cursor-pointer absolute top-1 right-1 text-white bg-black bg-opacity-50 p-1 rounded-xl"
              >
                {link === addedPhotos[0] && (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
