...
function PlacePage() {
        ...
        <div className="bg-black p-8 grid gap-4">
          <div>
            ...
            <button
              ...
              className="fixed shadow shadow-black gap-1 right-8 my-4 py-2 px-4 rounded-2xl bg-gray-400 text-white"
            >
              <svg
  ...
  return (
    <div className="mt-8 bg-gray-100 px-8 -mx-8">
      ...
      <div className="relative">
        ...
        <button
          ...
          className="flex gap-1 absolute bottom-2 right-2 py-2 px-4 bg-white rounded-2xl bg-opacity-90 shadow-lg"
        >
          More
          <svg
            xmlns="http://www.w3.org/2000/svg"
